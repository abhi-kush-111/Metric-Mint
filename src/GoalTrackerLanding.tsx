...
const GoalTrackerDemo = lazy(() => import('./components/GoalTrackerDemo'));
...
export default function GoalTrackerLanding() {
  ...
  const handlePayment = async () => {
    navigate('/goal-tracker/checkout');
    ...
    const options = {
      ...
      currency: 'INR',
      name: 'Goal Tracker',
      description: 'Ultimate Goal Tracker',
      image: '/hero.webp',
      handler: function (response: any) {
        navigate('/goal-tracker/thank-you');
      },
      prefill: {
        name: '',
        email: '',
  ...
  const faqs = [
    ...
    { question: 'Can I customize the goals?', answer: 'Absolutely. The sheet is fully editable. You can add up to 20 goals and change them anytime.' },
  ...
  if (location.pathname === '/goal-tracker/thank-you') {
    return (
      <div className="antialiased gradient-bg min-h-screen flex flex-col items-center justify-center p-6 text-center">
        <div className="glass-card p-8 md:p-12 rounded-3xl max-w-2xl w-full flex flex-col items-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-md">
            Thank you for your purchase. You can now access your Ultimate Goal Tracker Google Sheet.
          </p>
          <a 
    ...
    <div className="antialiased gradient-bg min-h-screen">
      ...
      <header className="pt-32 md:pt-44 pb-10 md:pb-12 px-0 md:px-6 flex flex-col items-center w-full overflow-hidden">
        <div className="px-6 md:px-0 flex flex-col items-center w-full">
          ...
          >
            A simple goal tracker that helps you stay consistent and see real progress. No fluff, just results.
          </motion.p>
        </div>
        ...
        >
          <div className="bg-gray-50 p-1.5 md:p-4 rounded-2xl md:rounded-[2.5rem] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] border border-white/50 relative overflow-hidden">
            <img 
              src="/hero.webp" 
              alt="Goal Tracker Dashboard Preview" 
        ...
        >
          ...
          <div className="flex flex-col items-center gap-4 w-full">
            <button 
              ...
              className="btn-purple px-5 md:px-6 py-2.5 md:py-3 rounded-full text-sm md:text-base font-bold text-center w-full md:w-auto flex items-center justify-center gap-2 mx-auto shadow-[0_5px_15px_rgba(72,13,76,0.1)] hover:shadow-[0_8px_25px_rgba(72,13,76,0.15)] transform hover:-translate-y-0.5 transition-all duration-300 relative overflow-hidden group"
            >
              <span className="absolute inset-0 w-full h-full bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:animate-shimmer"></span>
              <span className="flex items-center justify-center flex-wrap gap-1.5">
                ⚡ Get Instant Access — ₹49 Only
              </span>
              <span className="line-through text-purple-300/60 text-xs font-medium whitespace-nowrap">₹99</span>
            </button>
          </div>
      ...
      <section className="py-16 md:py-24 px-6 max-w-2xl mx-auto">
        ...
        <div className="space-y-4">
          {[
            ...
            "Progress disappears, goals feel pointless"
          ].map((text, i) => (
            <motion.div 
              key={i}
        ...
        >
          ...
          <br /> <span className="text-[10px] font-bold not-italic mt-4 block uppercase tracking-[0.2em] text-gray-400">— James Clear, Atomic Goals</span>
        </motion.div>
      </section>
              ...
              <div className="p-6 overflow-y-auto text-gray-600 text-sm leading-relaxed space-y-4">
                {showTerms ? (
                  <div className="space-y-4">
                    ...
                    <p>Welcome to MetricMint. These Terms and Conditions govern your purchase and use of the Ultimate Goal Tracker and any other digital products sold through our store. By completing a purchase, you agree to these terms in full.</p>
                    
                    <h4 className="font-bold text-gray-900 mt-6 text-base">2. License and Use</h4>
                    <p>When you purchase the Ultimate Goal Tracker, you are granted a non-exclusive, non-transferable license to use the product for personal, non-commercial purposes only.</p>
                    <ul className="list-none space-y-2 mt-2">
                      <li className="flex items-start gap-2"><span className="text-green-500 font-bold">✓</span> You MAY use the spreadsheet for your own personal goal tracking.</li>
                    ...
                    <p>All content, designs, templates, and assets included in the Ultimate Goal Tracker are the exclusive intellectual property of MetricMint. All rights are reserved. Unauthorized reproduction, modification, distribution, or commercial use of any part of our products is strictly prohibited and may result in legal action.</p>
